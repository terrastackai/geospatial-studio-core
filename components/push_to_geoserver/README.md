...
```
c3_create_operator --repository us.icr.io/gfmaas --dockerfile_template_path Dockerfile.template --log_level DEBUG --version v1.0.2-aug20-test4 --local_mode push_to_geoserver.py push_to_geoserver_helper_functions.py gfm_logger gfm_data_processing
```

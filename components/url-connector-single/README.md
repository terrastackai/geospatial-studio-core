...
```
c3_create_operator --repository us.icr.io/gfmaas --dockerfile_template_path Dockerfile.template --log_level DEBUG --version v1.0.2-aug16-test0 --local_mode url_connector_single.py gfm_logger gfm_data_processing preprocessing_helper
```

...
```
c3_create_operator --repository us.icr.io/gfmaas --dockerfile_template_path Dockerfile.template --log_level DEBUG --version v1.0.0 --local_mode run-inference.py gfm_logger gfm_data_processing inference_helper
```
